<template>
  <div class="mode2-items">
    <button
      @click="modeUpdate(0)"
      :style="[selectedMode == 0 ? { color: '#4F5B9A' } : { color: '#FFFFFF' }]"
    >
      식당
    </button>
    <button
      @click="modeUpdate(1)"
      :style="[selectedMode == 1 ? { color: '#4F5B9A' } : { color: '#FFFFFF' }]"
    >
      카페
    </button>
    <button
      @click="modeUpdate(2)"
      :style="[selectedMode == 2 ? { color: '#4F5B9A' } : { color: '#FFFFFF' }]"
    >
      술집
    </button>
